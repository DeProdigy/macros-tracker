---
linear_id: d1a23215-d3be-497e-a980-ef40e2a3e270
linear_title: "ARCHIVED — 01 — Architecture & Repo Structure"
linear_url: https://linear.app/hintology/document/archived-01-architecture-and-repo-structure-854c6ff9e12e
linear_updated_at: 2026-08-31T19:11:15.363Z
generated: true
---
...
│   │   ├── entries/          # DailyLog, FoodEntry, FoodItem
...
* **Apps split by domain**, not by layer. `accounts`, `targets`, `entries`, `ai`. Never `logging` — it shadows Python's stdlib module and breaks imports across Django and third-party packages. See doc 02.
